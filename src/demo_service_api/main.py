"""Runnable demo service backed by the Python standard library."""
...
def build_response(path: str) -> tuple[int, dict[str, object]]:
    ...
    if path == "/health":
        return 200, {"service": "demo-service-api", "status": "ok"}
...
def run() -> None:
    ...
    with make_server("127.0.0.1", 8000, application) as server:
        print("demo-service-api listening on http://127.0.0.1:8000")
